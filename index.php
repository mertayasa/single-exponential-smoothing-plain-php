        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title text-uppercase font-medium font-14">Beranda</h4>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                        <div class="white-box">                            
                            ...
                            <h4 class="text-center">SELAMAT DATANG DI SISTEM PERAMALAN PRODUKSI BAJU CHANDRA COLLECTION</h4>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-sm-6 col-xs-12">
                        <div class="white-box analytics-info">
                            ...
                            <ul class="list-inline two-part d-flex align-items-center mb-0">
                                ...
                                <?php 
                                    $x = mysqli_query($conn, "SELECT COUNT(nama_barang) AS total FROM tb_barang");	
                    ...
                    <div class="col-lg-6 col-sm-6 col-xs-12">
                        <div class="white-box analytics-info">
                            <h3 class="box-title">Jumlah Data Aktual</h3>
                            <ul class="list-inline two-part d-flex align-items-center mb-0">
                                <li>
                                ...
                                <?php 
                                    $x = mysqli_query($conn, "SELECT COUNT(data_aktual) AS total FROM tb_aktual");	
                                    $xx = mysqli_fetch_array($x);			
                                    echo $xx['total'];
                                ?>
                                </span></li>
