    ...
    if(isset($_POST['submit'])){
        if(editBarang($_POST) > 0){
            ...
            echo "<script>
                    ...
                    document.location.href = 'editBarang.php?id_barang=$id';    
            </script>";
        }
    }
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Silahkan Edit Data Barang!</h6>
                                ...
                                <input type="hidden" name="id_barang" value="<?= $row['id_barang']; ?>">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="nama_barang" required name="nama_barang" value="<?= $row['nama_barang'] ?>">
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="detail_barang" class="col-sm-2 col-form-label">Detail Barang</label>
                                        <div class="col-sm-6">
                                            <textarea name="detail_barang" class="form-control" id="" cols="30" rows="10"><?= $row['detail_barang'] ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6">
                                            ...
                                            <a href="daftarBarang.php" role="button" class="btn btn-danger">Kembali</a>
                                        </div>
                                    </div>
                                </form>
